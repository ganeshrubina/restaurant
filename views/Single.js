...
import { getUser, getRating } from "../hooks/APIHooks";
...
const Single = props => {
  ...
  return (
    <Container style={{ backgroundColor: "grey" }}>
      <Content>
        <CardItem style={{ backgroundColor: "#cc6051" }}>
          <Left>
            <Icon name="image" />
            <Body>
              <Text>{title}</Text>
              <Text>{description}</Text>
              <Text>Rating = {getRating.rating}</Text>
            </Body>
          </Left>
        </CardItem>
        <Card style={{ backgroundColor: "grey" }}>
          ...
          <CardItem style={{ marginTop: 100, backgroundColor: "grey" }}>
            <Left>
              <Icon name="person" />
              <Body>
                <Text>
